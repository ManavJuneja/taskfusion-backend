...
import com.Taskfusion.taskfusion.request.CreateCommentRequest;
import com.Taskfusion.taskfusion.response.MessageResponse;
import com.Taskfusion.taskfusion.service.CommentService;
...
public class CommentController {
    ...
    @GetMapping("/{issueId}")
    public  ResponseEntity<List<Comment>>getCommentByIssuesId(@PathVariable Long issueId){
